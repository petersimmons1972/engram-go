...
### R0-slice results — PENDING SCORE (scorer running as of plan update)

Results at `results/lme-s-r0-slice-nemotron-20260625/score_report.json` once scorer finishes.
Will be filled in and committed once scored.
...
### Updated sequence (as of R2 + R0-slice complete)

```
✅ R1 — LME-S, Nemotron + --preference-enumerate: ss-pref 23.3%/60.0%
✅ R2 — LME-M v10, Nemotron + full stack: ss-pref 6.9%/13.8%
✅ R0-slice — LME-S, Nemotron, NO flags: score PENDING
  → Compare R0-slice vs R1 (same generator, same dataset, flag on vs off)

...
func dispatch(args []string, stdout, stderr io.Writer) int {
	...
	// H15: dual-query preference recall (lme-h8h12h15 branch).
	// Opt-in only: default false so existing benchmark runs remain unchanged.
	fs.BoolVar(&cfg.DualPreferenceRecall, "dual-preference-recall", false, "H15: run a second subject-anchor recall for inferred preference questions and union both result sets (default: off)")

...
type Config struct {
	...
	ChronoLedgerInject   bool // prepend a chronological event-atom ledger for temporal-reasoning questions (default off)
...
func dispatch(args []string, stdout, stderr io.Writer) int {
	...
	fs.BoolVar(&cfg.ChronoLedgerInject, "chrono-ledger-inject", false, "Layer C B4: prepend an ordered, explicitly dated event-atom ledger to temporal-reasoning generation context (default off)")
	// Exp-14: H-M5 chrono-sort forcing + H-M1 entity enumeration pass
